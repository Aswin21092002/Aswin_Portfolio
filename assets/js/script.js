...
document.getElementById("send-btn").addEventListener("click", sendMessage); // Call sendMessage on button click
...
function sendMessage() {
  ...
  if (userText) {
    ...
    getBotResponse(userText.toLowerCase()); // Get bot's response
